...
CONTEXT_FEATURE_COLUMNS = [
    ...
    # Optional raw/annual context columns. These are imputed automatically when
    # missing and help document how World Bank / COW-style context could enter
    # the model without forcing all datasets to have perfect temporal coverage.
    ...
    # Optional GDELT/RAG enrichment columns.
    "gdelt_article_count", "gdelt_avg_tone", "gdelt_negative_share",
    ...
    for col in CONTEXT_FEATURE_COLUMNS:
        if col not in df.columns:
            if col == "cinc_ratio":
                ...
                df[col] = 0.35
            elif col.startswith("us_") or col.startswith("target_"):
                df[col] = 0.0
            else:
                df[col] = 0.0
